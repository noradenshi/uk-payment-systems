...
func TestProcessJSONPaymentRequest_WithSortCodes(t *testing.T) {
	body := `{"msg_id":"JSON-SORT-001","receiver_bic":"HSBCGB44","amount":250.00,"receiver_sort_code":"40-00-00"}`
...
func TestProcessJSONPaymentRequest_MissingReceiverSortCode(t *testing.T) {
	body := `{"msg_id":"JSON-NOSORT-001","receiver_bic":"HSBCGB44","amount":100.00}`

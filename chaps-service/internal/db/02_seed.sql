...
WITH seed_data (bic, name, sort_code, api_key, bal) AS (
    VALUES 
        ('BARCGB2L', 'Barclays Bank', '20-00-00', 'ak_barcgb2l_dev', 1000000.00),
        ('HSBCGB44', 'HSBC UK', '40-00-00', 'ak_hsbcgb44_dev', 500000.00),
        ('LLOYGB21', 'Lloyds Bank', '30-00-00', 'ak_lloygb21_dev', 750000.00),
        ('SNDRUK22', 'Alice Bank', '60-00-00', 'ak_sndruk22_dev', 1000000.00)
),
ins_profiles AS (
    INSERT INTO participant_profiles (bic_code, name, sort_code, api_key)
    SELECT bic, name, sort_code, api_key FROM seed_data
    RETURNING bic_code
),
ins_statuses AS (
